...
describe("GET /companies", function () {
  ...
  test("filters by name", async function() {
    const resp1 = await request(app).get("/companies?name=1")
    ...
    const resp2 = await request(app).get("/companies?name=c")
  ...
  test('filters by employees', async function() {
  ...
  test("returns 404 if minEmployees is greater than maxEmployees", async function(){
